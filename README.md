...
##ToDo
1. Setup http://gridster.net/#usage
2. Setup a page for each strategy showing the Graph of data vs forecast model, error rates, confidence intervals (data table?)
3. Setup each Ticker to have a stop and start button.
4. Style Pages
5. Prepare Talk
